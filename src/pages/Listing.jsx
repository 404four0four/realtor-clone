            ...
            <div className='m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5'>
                <div className='w-full min-h-[200px] lg:h-[400px] z-10 overflow-x-hidden mt-6 lg:mt-0'>
                    ...
                    <div className='flex justify-start items-center space-x-4 w-[75%]'>
                        ...
                        {listing.offer && (
                            <p className='bg-green-800 text-white w-full max-w-[200px] rounded-md p-1 text-center font-semibold shadow-md'>${+listing.regularPrice - +listing.discountedPrice} discount</p>
                        )}
                    </div>
